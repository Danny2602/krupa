...
const prosthesisData = [
    {
        id: 1,
        name: 'Prótesis Total de Rodilla (PTR)',
        category: 'Total',
        description: 'Reemplazo total de rodilla de última generación con superficie de polietileno ultra-congruente.',
        features: ['Componente femoral de cobalto-cromo', 'Meseta tibial de titanio', 'Polietileno UHMWPE', 'Preserva ligamentos cruzados'],
        image: 'https://via.placeholder.com/400x300/012558/FFFFFF?text=PTR+Total'
    },
    {
        id: 2,
        name: 'Prótesis Unicompartimental',
        category: 'Parcial',
        description: 'Reemplazo parcial de rodilla para artrosis localizada en un solo compartimento.',
        features: ['Mínimamente invasiva', 'Recuperación rápida', 'Preserva hueso', 'Sensación natural'],
        image: 'https://via.placeholder.com/400x300/f57922/FFFFFF?text=Unicompartimental'
    },
    {
        id: 3,
        name: 'Prótesis de Rodilla con Rótula',
        category: 'Total',
        description: 'Sistema completo incluyendo componente patelar para máxima cobertura articular.',
        features: ['Componente patelar de polietileno', 'Surco troclear optimizado', 'Seguimiento rotuliano', 'Reduce dolor anterior'],
        image: 'https://via.placeholder.com/400x300/012558/FFFFFF?text=Con+Rotula'
    },
    {
        id: 4,
        name: 'Prótesis de Revisión de Rodilla',
        category: 'Revisión',
        description: 'Sistema modular para casos de revisión con pérdida ósea significativa.',
        features: ['Vástagos modulares', 'Aumentos metafisarios', 'Constreñimiento variable', 'Estabilidad máxima'],
        image: 'https://via.placeholder.com/400x300/f57922/FFFFFF?text=Revision'
    },
    {
        id: 5,
        name: 'Prótesis de Rodilla de Género Específico',
        category: 'Total',
        description: 'Diseño anatómico específico para morfología femenina o masculina.',
        features: ['Anatomía específica', 'Ajuste optimizado', 'Múltiples tamaños', 'Mejor cinemática'],
        image: 'https://via.placeholder.com/400x300/012558/FFFFFF?text=Genero+Especifico'
    },
    {
        id: 6,
        name: 'Implante Biodinámico de Rodilla',
        category: 'Total',
        description: 'Tecnología avanzada que imita la biomecánica natural de la rodilla.',
        features: ['Movilidad biológica', 'Reducción de desgaste', 'Sensor de movimiento', 'Tecnología inteligente'],
        image: 'https://via.placeholder.com/400x300/f57922/FFFFFF?text=Biodinamico'
    }
];

const categories = ['Todas', 'Total', 'Parcial', 'Revisión'];
        ...
        <Box className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12">
            <Container maxWidth="xl">
                ...
                >
                    ...
                    >
                        Tecnología avanzada para restaurar la movilidad y calidad de vida
                    </Typography>
