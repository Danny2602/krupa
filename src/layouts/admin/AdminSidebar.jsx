...
import { FaHome, FaSignOutAlt, FaChevronLeft, FaChevronRight, FaBars, FaUserMd, FaUsers, FaCalendarAlt, FaNewspaper } from "react-icons/fa";
...
const menuItems = [
    ...
    { label: "Especialidades", icon: <MdMedicalServices />, path: '/admin/specialties' },
    { label: "Doctores", icon: <FaUserMd />, path: '/admin/doctors' },
    { label: "Usuarios", icon: <FaUsers />, path: '/admin/users' },
    { label: "Citas", icon: <FaCalendarAlt />, path: '/admin/appointments' },
    { label: "Noticias", icon: <FaNewspaper />, path: '/admin/news' },
        ...
        <>
            ...
            {isMobile && (
                <button
                    ...
                    className="fixed top-4 left-4 z-60 bg-purple-900 p-2 rounded-sm text-white shadow-lg"
                    style={{ padding: '1vh' }}
                >
                    <FaBars size={22} />
                </button>
            ...
            >
                {/* Botón de expansión (solo desktop) */}
                {!isMobile && (
                    <div
                        className="cursor-pointer flex items-center justify-center bg-purple-600 rounded-full hover:bg-purple-700 transition-colors"
                        style={{
                            width: "40px",
                            height: "40px",
                            marginBottom: "2rem",
