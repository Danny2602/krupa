...
import { FaHome, FaSignOutAlt, FaChevronLeft, FaChevronRight, FaBars } from "react-icons/fa";
import useScrollAndMobile from "@/hooks/useScrollAndMovile";
import { useAuth } from "@/context/AuthContext";

const menuItems = [
    { label: "Dashboard", icon: <FaHome />, path: '/doctor/home' },
    { label: "Salir", icon: <FaSignOutAlt />, path: '/' },
];

const MotionNavLink = motion(NavLink);

function DoctorSidebar({ isOpen, setIsOpen }) {
